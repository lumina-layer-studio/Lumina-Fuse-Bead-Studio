...
```text
artifacts/lumina.bead-pattern-1.0.7.lumina-workshop
artifacts/lumina.bead-pattern-1.0.7.lumina-workshop.sha256
```
...
python -m core.workshop.package_validator \
  /absolute/path/to/artifacts/lumina.bead-pattern-1.0.7.lumina-workshop
```
